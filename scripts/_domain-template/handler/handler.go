...
import (
	...
	"__MODULE__/internal/__domain__/service"
	apperrors "__MODULE__/internal/pkg/errors"
	"__MODULE__/internal/pkg/response"
...
type Handler struct {
	svc service.__Domain__Service
}

func NewHandler(svc service.__Domain__Service) *Handler {
