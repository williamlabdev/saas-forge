...
var agentActionExpectations = map[string]bool{
	...
	ActionTenantInviteList:    false,
	ActionTenantInviteRevoke:  false,
	ActionTenantMemberList:    false,
	ActionTenantMemberUpdate:  false,
	ActionTenantMemberRemove:  false,
	...
	ActionNotificationMarkRead:  false,
