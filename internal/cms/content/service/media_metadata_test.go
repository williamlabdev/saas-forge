...
// this list — widening the delivery surface takes a ruling, and a column
...
func TestMedia_DeliveryDTOKeySetIsFrozen(t *testing.T) {
	...
	require.ElementsMatch(t, deliveryMediaKeys, jsonKeys(t, ProjectMediaAsset(a, deliverySubject())),
		"the delivery media response is frozen: adding a key here is a governance decision, not a refactor")
}
