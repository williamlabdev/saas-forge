...
func TestTheToolSurfaceIsTheStepSevenSet(t *testing.T) {
	...
	assert.ElementsMatch(t, []string{
		...
		// ADR-020 §10: two READS. The component surface has no write tool for
		// the same reason /types has none here — schema is proposed, not written.
		"cms_list_components", "cms_get_component",
	}, got)
